...
func (m *MockAPIUtil) CreateSession() (*models.Session, error) {
	m.ctrl.T.Helper()
...
func (mr *MockAPIUtilMockRecorder) CreateSession() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateSession", reflect.TypeOf((*MockAPIUtil)(nil).CreateSession))
}
